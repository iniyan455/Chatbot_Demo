...
public class MessengerActivity extends AppCompatActivity implements NetworkCallbackResponse, RecognitionListener {
    ...
    private static final int REQUEST_AUDIO_PERMISSION_RESULT = 204;
    ...
    @VisibleForTesting
    protected static final int BACKGROUND_COLOR = R.color.colorAccent;
    @VisibleForTesting
    ...
    private void onClickButtonSendMessage() {
        ...
        if (!Objects.equals(message.getText(), "")) {        //Set to chat view
...
//                    speechRecognizer.startListening(intent);
    ...
    private void initUsers() {
        ...
        int myId = 0;
        //User icon
        Bitmap myIcon = BitmapFactory.decodeResource(getResources(), R.drawable.face3);
        //User name
...
//                }
    ...
    public void onResults(Bundle bundle) {
        ...
        if (matches.get(0) != null) {
            ...
            if (!tts.isSpeaking()) speechProccessResult(matches.get(0));
